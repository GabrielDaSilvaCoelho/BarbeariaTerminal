...
```
[Cliente]                        [Administrador da Barbearia]
    |  Agenda serviços                  |  Gerencia serviços e agenda
    |  e acompanha status.              |
    +----------------+------------------+
                     |
              [ Barber Pro ]
          [Software System]
    Sistema web distribuído para
    gerenciamento de barbearia com
    mensageria e atualização em tempo real.
                     |
          Envia notificações de eventos.
                     |
       [Serviço de Notificação]
          [Software System]
    Recebe eventos para envio de mensagens.
```
